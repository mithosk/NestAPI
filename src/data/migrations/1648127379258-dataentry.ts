...
export class dataentry1648127379258 implements MigrationInterface {
    public async up(qr: QueryRunner): Promise<void> {
        await qr.query('INSERT INTO categories (uuid, code) VALUES (\'3260f259-a60a-4bd2-886d-adaea7916017\', \'BOOK\')')
        await qr.query('INSERT INTO categories (uuid, code) VALUES (\'4d0109bc-b5ff-4d4d-b1a9-83cc939e09b7\', \'CALENDAR\')')
